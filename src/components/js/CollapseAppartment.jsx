...
function CollapseAppartment() {
    ...
    return <div className="collapses-appartment">
        <div className={`collapses-appartment__collapse ${isDescriptionOpen ? 'collapses-appartment__collapse--open' : ''}`}>
            ...
            {isDescriptionOpen && <p className="collapses-appartment__collapse--title-arrow-content-description">{currentAppartment.description}</p>}
        </div>
        ...
        <div className={`collapses-appartment__collapse ${isEquipmentsOpen ? 'collapses-appartment__collapse--open' : ''}`}>
            ...
            {isEquipmentsOpen && <div className="collapses-appartment__collapse--title-arrow-content-equipement">
